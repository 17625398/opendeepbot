...
# Forensic analysis tools (lazy-loaded to avoid circular dependency)
def _get_legal_ie_tool():
    from .legal_ie_tool import legal_ie_tool
    return legal_ie_tool

def _get_langextract_tool():
    from .langextract_tool import langextract_tool
    return langextract_tool

def _get_log_parser_tool():
    from .log_parser_tool import log_parser_tool
    return log_parser_tool

def _get_chat_parser_tool():
    from .chat_parser_tool import chat_parser_tool
    return chat_parser_tool

def _get_doc_llama_tool():
    from .doc_llama_tool import doc_llama_tool
    return doc_llama_tool

def _get_forensics_py_tool():
    from .forensics_py_tool import forensics_py_tool
    return forensics_py_tool

def _get_memagent_tool():
    from .memagent_tool import memagent_tool
    return memagent_tool

def _get_evidence_correlation_tool():
    from .evidence_correlation_tool import evidence_correlation_tool
    return evidence_correlation_tool

# Add forensic tools to aliases
TOOL_ALIASES["legal_ie"] = ("legal_ie", {})
TOOL_ALIASES["langextract"] = ("langextract", {})
TOOL_ALIASES["log_parser"] = ("log_parser", {})
TOOL_ALIASES["chat_parser"] = ("chat_parser", {})
TOOL_ALIASES["doc_llama"] = ("doc_llama", {})
TOOL_ALIASES["forensics_py"] = ("forensics_py", {})
TOOL_ALIASES["memagent"] = ("memagent", {})
TOOL_ALIASES["evidence_correlation"] = ("evidence_correlation", {})
