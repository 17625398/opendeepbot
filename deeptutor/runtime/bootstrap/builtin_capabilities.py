...
BUILTIN_CAPABILITY_CLASSES: dict[str, str] = {
    ...
    "llamaindex_agent": "deeptutor.capabilities.llamaindex_agent:LlamaIndexAgentCapability",
    "forensics_investigation": "deeptutor.capabilities.forensics_investigation:ForensicsInvestigationCapability",
    "deep_coding": "deeptutor.capabilities.deep_coding:DeepCodingCapability",
}
